            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header table">
                        <label for="logNameselect">Escolha o histórico requisitado:</label>
                        ...
                        <p>
                            ...
                            */
                            // percorrer os arrays
                                ...
                                if($select == "humidity_log"){
                                    echo "<tr><td>" . $humidity_log['log'][$x]['hour'] . "</td><td>" . $humidity_log['log'][$x]['value'] . '</td></tr>';
                                }
                                if($select == "dioxideCarbonLevel_log"){
                                    echo "<tr><td>" . $dioxideCarbonLevel_log['log'][$x]['hour'] . "</td><td>" . $dioxideCarbonLevel_log['log'][$x]['value'] . '</td></tr>';
                                }
                                if($select == "warningOpenWindow_log"){
                                    echo "<tr><td>" . $warningOpenWindow_log['log'][$x]['hour'] . "</td><td>" . $warningOpenWindow_log['log'][$x]['value'] . '</td></tr>';
                                }
                                if($select == "light_log"){
                                    echo "<tr><td>" . $light_log['log'][$x]['hour'] . "</td><td>" . $light_log['log'][$x]['value'] . '</td></tr>';
                                }
                                if($select == "electricity_log"){
                                    echo "<tr><td>" . $electricity_log['log'][$x]['hour'] . "</td><td>" . $electricity_log['log'][$x]['value'] . '</td></tr>';
                                }
